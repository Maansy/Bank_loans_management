...
urlpatterns = [
    path('create-fund/', create_fund, name='create-fund'), # test is done
    path('get-funds/', get_funds, name='get-funds'), # test is done
    path('get-fund/<int:pk>/', get_fund, name='get-fund'), # test is done
    path('request-fund/<int:pk>/', request_fund, name='request-fund'), # test is done
    path('approve-fund-request/<int:pk>/', approve_fund_request, name='approve-fund-request'), # test is done 
    path('get-non-assigned-fund-request/', get_non_assigned_fund_request, name='get-fund-request'),  # test is done
    path('reject-fund-request/<int:pk>/', reject_fund_request, name='reject-fund-request'), # test is done
